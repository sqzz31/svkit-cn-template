...
import { x as ATTACHMENT_KEY, y as attributes, z as clsx$1, F as bind_props, G as derived, J as props_id, K as spread_props } from "../../chunks/index.js";
import { twMerge } from "tailwind-merge";
import { tv } from "tailwind-variants";
import { l as run } from "../../chunks/context.js";
...
function Card_footer($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attributes({
      ...
      class: clsx$1(cn("[.border-t]:pt-6 flex items-center px-6", className)),
      ...restProps
    })}>`);
    children?.($$renderer2);
    $$renderer2.push(`<!----></div>`);
...
function _page($$renderer) {
  $$renderer.push(`<main>`);
  Card($$renderer, {
    class: "w-full max-w-sm rounded-2xl bg-white shadow-lg",
    children: ($$renderer2) => {
      Card_header($$renderer2, {
        children: ($$renderer3) => {
          Card_title($$renderer3, {
            children: ($$renderer4) => {
              $$renderer4.push(`<!---->Login to your account`);
            },
            $$slots: { default: true }
          });
          $$renderer3.push(`<!----> `);
          ...
          $$renderer3.push(`<!----> `);
          Card_action($$renderer3, {
            children: ($$renderer4) => {
              Button($$renderer4, {
                variant: "link",
                children: ($$renderer5) => {
                  $$renderer5.push(`<!---->Sign Up`);
                },
                $$slots: { default: true }
              });
            },
      ...
      Card_content($$renderer2, {
        children: ($$renderer3) => {
          $$renderer3.push(`<form><div class="flex flex-col gap-6"><div class="grid gap-2">`);
          Label($$renderer3, {
            for: "email",
            children: ($$renderer4) => {
          ...
          $$renderer3.push(`<!----></div> <div class="grid gap-2"><div class="flex items-center">`);
          Label($$renderer3, {
            for: "password",
            children: ($$renderer4) => {
          ...
          $$renderer3.push(`<!----> <a href="##" class="ml-auto inline-block text-sm underline-offset-4 hover:underline">Forgot your password?</a></div> `);
          Input($$renderer3, { id: "password", type: "password", required: true });
      ...
      Card_footer($$renderer2, {
        ...
        children: ($$renderer3) => {
          ...
          Button($$renderer3, {
            ...
            class: "w-full",
            children: ($$renderer4) => {
              $$renderer4.push(`<!---->Login with Google`);
            },
            $$slots: { default: true }
          });
          $$renderer3.push(`<!---->`);
